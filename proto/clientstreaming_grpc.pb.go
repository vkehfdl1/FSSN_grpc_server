...
func (x *clientStreamingGetServerResponseClient) Send(m *ClientMessage) error {
...
func (x *clientStreamingGetServerResponseServer) Recv() (*ClientMessage, error) {
	m := new(ClientMessage)
...
var ClientStreaming_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "proto/FSSN_grpc_proto/clientstreaming.proto",
}
